...
public class RPCMessage {
	 ...
	 * @author xiaoming
	 * @date: 2018年10月30日 下午4:50:40
	 */
	public enum TargetType {
	    BATCH_REQUEST,
        BATCH_RESPHONE,
        TX_WAIT,HASHLIST,BLOCK,VOTE_1,VOTE_2,
        GET_PUBLICKEY,GET_BLOCK,GET_TRANS_HASH,GET_TRANS_KEY,GET_TRANS_LIST,GET_TRANS_HISTORY,
        ...
        CREATE_CONTRACT,RUN_CONTRACT,FREEZE_CONTRACT,UNFREEZE_CONTRACT,UPDATE_CONTRACT,MIGRATE_CONTRACT
    }
