...
//        log.debug("tdmsg {}",JSON.toJSONString(tdmsg));   
    ...
    private static void createECCCert() {
        ...
        SystemConfig keyStoreParam = getEccKeyStoreParam();
...
//        log.info("createECCCert end");
    ...
    private static SystemConfig getEccKeyStoreParam() {
        SystemConfig keyStoreParam = new SystemConfig("", "");
...
//            log.error(e.getMessage(), e);
    ...
    private static void createSM2Cert() {
        ...
        SystemConfig keyStoreParam = getSM2KeyStoreParam();
...
//        log.info("createSM2Cert end");
    ...
    private static SystemConfig getSM2KeyStoreParam() {
        SystemConfig keyStoreParam = new SystemConfig("", "");
...
//        keyStoreParam.setPrivateKeyAlias("test1_privateKey");
        ...
        keyStoreParam.setCertAlias("ou1Cert");
//        keyStoreParam.setAlias("rootCert");
//        keyStoreParam.setValidTime(5);

//        keyStoreParam.setKsPassword("123456");

//        keyStoreParam.setKsPath("./msp/ca/ou/sm2/");
//        keyStoreParam.setKsFileName("sm2OU1.pfx");
...
//        log.info("createRSARootCert end");
    ...
    private static void createRSACert() {
        RsaCertificate rsa = new RsaCertificate();
        SystemConfig keyStoreParam = getKeyStoreParam();
...
//        log.info("createRSACert end");
     ...
     * @return
     */
    private static SystemConfig getKeyStoreParam() {
        SystemConfig keyStoreParam = new SystemConfig("", "");
...
//        keyStoreParam.setKsPath("./msp/ca/ou/");
//        keyStoreParam.setKsFileName("test1.pfx");
